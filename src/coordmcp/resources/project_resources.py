...
def _format_project_overview(project_info) -> str:
    ...
    lines = [
        ...
        f"**Last Updated:** {getattr(project_info, 'updated_at', 'N/A')}",
        "",
        "## Description",
    ...
    if not decisions:
        ...
        for decision in decisions:
            ...
            lines.extend([
                ...
                f"**Date:** {getattr(decision, 'created_at', 'N/A')}",
                f"**Author:** {getattr(decision, 'author_agent_id', 'Unknown') or 'Unknown'}",
                "",
                "### Description",
    ...
    if not changes:
        ...
        for change in changes:
            ...
            lines.extend([
                ...
                "",
                f"**Date:** {getattr(change, 'created_at', 'N/A')}",
